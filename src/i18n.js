...
const STR = {
  en: {
    ...
    hero_need_care: (n) => `${n} ${n === 1 ? 'plant needs' : 'plants need'} care today`,
    hero_view_tasks: 'View my tasks',
    hero_status: 'Your plants are happy and thriving 🌿',
    needs_care_sub: "Tap to see today's care schedule",
    all_caught_up: 'All caught up — nothing due today 🎉',
    ai_title: 'Ask AI Plant Care', ai_kicker: 'AI Plant Care',
    ai_banner_sub: 'Get instant answers about watering, pests, sunlight, and more.',
    ai_ask_now: 'Ask now',
    quick_identify: 'Identify Plant', quick_identify_sub: 'Take a photo to recognize plants',
    quick_water: 'Water Reminder', quick_water_sub: 'Never miss watering',
    quick_calendar: 'Care Calendar', quick_calendar_sub: 'Plan your care schedule',
    todays_tasks: "Today's Tasks", task_water: 'Water',
  ...
  id: {
    ...
    hero_need_care: (n) => `${n} tanaman perlu dirawat hari ini`,
    hero_view_tasks: 'Lihat tugasku',
    hero_status: 'Tanamanmu sehat dan tumbuh subur 🌿',
    needs_care_sub: 'Ketuk untuk lihat jadwal perawatan hari ini',
    all_caught_up: 'Semua beres — tidak ada tugas hari ini 🎉',
    ai_title: 'Tanya AI Perawatan Tanaman', ai_kicker: 'AI Perawatan Tanaman',
    ai_banner_sub: 'Dapatkan jawaban instan soal penyiraman, hama, cahaya, dan lainnya.',
    ai_ask_now: 'Tanya sekarang',
    quick_identify: 'Identifikasi', quick_identify_sub: 'Foto untuk mengenali tanaman',
    quick_water: 'Pengingat Siram', quick_water_sub: 'Jangan lupa menyiram',
    quick_calendar: 'Kalender Rawat', quick_calendar_sub: 'Atur jadwal perawatan',
    todays_tasks: 'Tugas Hari Ini', task_water: 'Siram',
